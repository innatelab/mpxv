# Msglm fit chunk for the mpxc phospho data, phospho
...
msglm.stan_fit <- fit_model(model_data, adapt_delta=0.9,
                            ...
                            stanmodel_options = list(
                              ...
                              effect_slab_scale = 1.3, effect_slab_df = 18, #Decrease scale and increase df to make the regularisation more stringent!!! So there will be less extreme fold changes.
